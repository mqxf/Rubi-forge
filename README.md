...
A *very heavily* vibecoded fork of [Rubi](https://github.com/keve1227/rubi), a mod for Minecraft Fabric which adds
the ability to display custom Japanese language files with furigana.

Alongside the forge fork (I did this to learn Japanese technical words while playing GregTech Odyssey), this mod
